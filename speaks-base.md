...
Для вас есть небольшое задание. Попробуйте
подсчитать, сколько видео роликов увидели, пока мы
с вами не встретились сегодня, а сколько ещё встретите
за день?
...
- медицина - телемедицина, видеотехнологии для удаленной
  ...
  за состоянием пациентов при помощи ИИ.
...
(по-другому Quality
assurance specialist или
QA-инженер)
Чем занимается
тестировщик:
тестирование продукта,
поиск багов, подготовка
отчетов, общение с
разработчиками, работа с
документацией.
